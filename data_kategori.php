...
<head>
    ...
    <title>Data Kategori | LibSys</title>
    ...
    <style>
        ...
        .modal-form {
            ...
            /* Tambahkan ini */
            padding-right: 1rem;
            /* Opsional, biar kiri-kanan seimbang */
        }
...
<body>
        ...
        <div>
            ...
            <nav>
                <ul>
                    ...
                    <li>
                        <a href="data_kategori.php" class="sidebar-item active">
    ...
    <main class="main-content-wrapper">
        <header class="main-header">
            <h1 class="main-header-title">Data Kategori Buku</h1>
        ...
        <section class="card-data-table">
            <div class="table-controls">
                <button id="addKategoriBtn" class="action-btn btn-add">
                ...
                <table>
                    ...
                    <tbody>
                        <?php if (empty($kategori_data)): ?>
                            <tr>
                                <td colspan="3" class="text-center-col" style="padding: 2rem; color: #6b7280; font-weight: normal;">Tidak ada data kategori yang tersedia.</td>
                            </tr>
                        <?php else: ?>
                            <?php $no = 1;
    ...
    <div id="kategoriModal" class="modal">
        <div class="modal-content">
            ...
            <h2 id="modalTitle" class="modal-title-text">Tambah Kategori Baru</h2>
            <form id="kategoriForm" action="proses_kategori.php" method="POST" class="modal-form">
                <input type="hidden" id="formAction" name="action" value="tambah">
                <input type="hidden" id="kategoriId" name="id_kategori">

                <div class="modal-form-group">
                    <label for="nama_kategori" class="modal-form-label">Nama Kategori</label>
                    <input type="text" id="nama_kategori" name="nama_kategori" class="modal-form-input" required>
                </div>
    ...
    <div id="deleteConfirmModal" class="modal">
        <div class="modal-content">
            ...
            <p class="modal-text">Apakah Anda yakin ingin menghapus kategori "<span id="deleteKategoriNama" style="font-weight: 600;"></span>"?</p>
            <div class="modal-buttons-container">
    ...
    <script>
        ...
        addKategoriBtn.onclick = function() {
        ...
        function openEditModal(button) {
            modalTitle.textContent = 'Edit Data Kategori';
            formAction.value = 'edit';
            kategoriId.value = button.dataset.id;
        ...
        function openDeleteModal(button) {
            ...
            deleteKategoriNama.textContent = nama;
            confirmDeleteBtn.href = 'proses_kategori.php?action=hapus&id=' + id;
